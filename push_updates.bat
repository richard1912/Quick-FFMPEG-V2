...
:: Quick-FFMPEG-V2 Update Pusher Script (Windows Version)
:: This script helps push updates to the develop branch of the Quick-FFMPEG-V2 repository

:: Main script starts here
echo Starting Quick-FFMPEG-V2 Update Process...
echo.

:: Check if we're in a git repository
if not exist ".git" (
    echo [ERROR] Not in a git repository. Please run this script from the Quick-FFMPEG-V2 project directory.
    pause
    exit /b 1
)
...
git remote set-url origin https://github.com/richard1912/Quick-FFMPEG-V2.git
if errorlevel 1 (
...
echo [INFO] Repository: https://github.com/richard1912/Quick-FFMPEG-V2.git
